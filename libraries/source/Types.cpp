...
namespace Play
{
	...
	int& Player::get_lives() noexcept
	{
		return this->lives;
	}

	void Player::decrease_lives() noexcept
	{
		--this->lives;
	}

	void Player::increase_lives() noexcept
	{
		++this->lives;
	}
}
