...
{
    if (!barco_texture.loadFromFile("resources/textures/boteNaval-S.png") ||
        ...
        !pirate_map.loadFromFile("resources/textures/WoodTable.jpg")) 
    {
        throw std::runtime_error("No se pudieron cargar las texturas");
    }
    agua_texture = Painter::Resources::get_texture(Painter::Resources::water_image());
}
